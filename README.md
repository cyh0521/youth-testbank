...
- Word／PDF 下載與直接列印前可選擇 A3（297×420 mm）、A4（210×297 mm）或 JIS B4（257×364 mm），以及單欄或雙欄題目版面；兩組選項都有示意圖，選擇會記在目前瀏覽器。雙欄時表頭與解答保留整頁寬度。
- Word／PDF／直接列印共用頁邊距設定，預設上下左右各 10 mm，可在側邊欄「進階設定 → 試卷版面設定 → 試卷邊距」調整為 5～50 mm；設定儲存在目前瀏覽器。
